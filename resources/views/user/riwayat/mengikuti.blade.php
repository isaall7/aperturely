             ...
             <div class="col-lg-9">
                <div class="main-content">
                    <div class="page-header">
                        ...
                        <p class="page-subtitle">Lihat semua orang yang mengikuti oleh anda.</p>
                    </div>
                ...
                @if($followingUsers->count() > 0)
                            ...
                            <div class="user-card">
                                <div class="user-card-header">
                                    <a href="{{ route('user.profile.username', ['name' => $follow->followed->name]) }}">
                                        <img src="{{ $follow->followed->avatar_display ?? 'https://ui-avatars.com/api/?name=User' }}" 
                    ...
                    <div class="empty-state">
                        ...
                        <h3 class="empty-title">Belum Ada yang mengikuti</h3>
