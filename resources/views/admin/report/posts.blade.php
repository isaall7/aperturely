...
@section('title', 'Laporan Postingan')

@section('content')
<div class="container px-4 mt-5 ">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Laporan Postingan</h1>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('admin.report.post') }}" method="GET" class="row g-3">
                <div class="col-md-10">
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="bi bi-file-post"></i> Daftar Laporan Postingan</h5>
        </div>
        <div class="card-body p-0">
            @if($reports->isEmpty())
                <div class="text-center py-5">
                    <i class="bi bi-inbox fs-1 text-muted"></i>
                    <p class="text-muted mt-2">Tidak ada laporan postingan</p>
                </div>
            @else
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($report->post)
                                        <div>{{ Str::limit($report->post->content, 80) }}</div>
                                        <small class="text-muted">
                                            Status: 
                                            <span class="badge {{ $report->post->status === 'banned' ? 'bg-danger' : 'bg-success' }}">
                                                {{ ucfirst($report->post->status) }}
                                            </span>
                                        </small>
                                    @else
                                        <span class="text-muted">Postingan dihapus</span>
                                    @endif
                                </td>
                                <td>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            @if($report->post)
                                                <div class="mb-3">
                                                    <h6>Konten Postingan</h6>
                                                    <div class="border rounded p-3 bg-light">
                                                        <img 
                                                            src="{{ asset('storage/' . $report->post->photo) }}" 
                                        ...
                                        <div class="modal-content">
                                            <form action="{{ route('admin.post.ban', $report->post->id) }}" method="POST">
                                                ...
                                                <div class="modal-header bg-danger text-white">
                                                    <h5 class="modal-title">Ban Postingan</h5>
                                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="alert alert-warning">
                                                        <i class="bi bi-exclamation-triangle"></i>
                                                        Anda akan memban postingan dari <strong>{{ $report->reportedUser->name }}</strong>
                                                    </div>
                                                    <div class="mb-3">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-danger">
                                                        <i class="bi bi-ban"></i> Ban Postingan
                                                    </button>
                                                </div>
                                            </form>
                                        </div>
