          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <div class="d-flex flex-column">
                <span class="fw-semibold text-dark">Panel Admin</span>
                <small class="text-muted">Moderasi dan pengelolaan platform</small>
              </div>
            </li>
          </ul>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    <a href="{{ auth()->check() ? route('user.profile') : route('login') }}" class="d-flex align-items-center gap-2 dropdown-item">
