    ...
    <div style="display:flex;align-items:center;gap:10px;flex-shrink:0;">
        ...
        <div class="ap-profile-wrap">
            ...
            <div class="ap-dropdown">
                ...
                <div class="ap-dd-sep"></div>
                <button type="button" class="ap-dd-item" onclick="event.preventDefault(); document.getElementById('user-navbar-logout-form').submit();" style="width:100%;border:none;background:none;text-align:left;">
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                ...
                <form id="user-navbar-logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                    @csrf
                </form>
            </div>
        </div>
